...
$clubIds=App\Models\ClubTeam::where('id',$clubId)->orWhere('parent_id',$clubId)->pluck('id')->toArray();
$rows=DB::table('match_predictions')
    ...
    ->get();
foreach($rows as $r){echo "$r->match_id\t$r->home_name vs $r->away_name\tcount=$r->total\n";}
